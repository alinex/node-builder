...
# not capture the errors using `process.on 'uncaughtException'`.
#
# To use the error handler it should be added for uncaught exceptions in the
# main routine using:
#
#     process.on 'uncaughtException', errorHandler.uncaughtError
#
# This will capture the error, log it and stop processing.
#
# Alternatively an already caught Error may be reported using
#
#     errorHandler.report error
#
# The error may have some nested errors in it's `cause` property. All this
# additional information will be reported if it is found.
